var genParser = (function(tys, tree, start) {
  ...
  var funcs = {
    expression: function(o) {
      ...
      while (n = isIndexItem(r, props = {})) {
        if (props._matched === r.contains[0]) {
          EXPRS.push(n);
        } else
        if (props._matched === opers) {
    ...
    repeat: function(o, props) {
      var reto = [],
        e, d, _ind = index,
        l, p, D = o.delimiting,
        i = 0,
        p = D && o.multipleDelimeters,
        props2;
      d = o.contains;
      props.props = [];
      do {
